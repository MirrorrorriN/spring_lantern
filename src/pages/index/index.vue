...
export default {
    ...
    mounted() {
        ...
        backgroundAudioManager.title = "步步高";
        backgroundAudioManager.epname = "步步高";
        backgroundAudioManager.singer = "中央民族乐团";
    ...
    methods: {
        ...
        queryRiddleAnswer() {
            if (this.score < 10) {
                ...
                get("/riddle/queryAnswer", {riddleId: riddleId,openid: openid}).then(res => {
                    if (res.errno === 0) {
                        this.score -= 10;
                        this.correct = 3;
                    } else {
